...
namespace 알고리즘
{
    ...
    public class 그룹
    {
        public 
        {
            ...
            {
                console.log("{0} {1}", lst[i].Name, lst[i].Quantity);
            }
            //[B] 정렬
            ...
            //for (var i = 0; i < lst.Count - 1; i++) // 마지막 레코드(빈) 전까지 
            //{
            ...
            //[3] Output
            console.log("그룹화된 자료 출력");
            for (var i = 0; i < result.Count; i++)
            {
                console.log("{0} {1}", result[i].Name, result[i].Quantity);
            }
        }
    } 
}
