/// <reference path="Gambit.Han.ChoLeft.HanRight.js" />
/// <reference path="Gambit.Han.ChoLeft.HanRight.js" />
/// <reference path="../JanggiEngine/JanggiEngine.js" />
...
com.init = function (stype) {
    ...
    com.nowStype = stype || com.getCookie("stype") || "Small";
...
window.onload = function () {
    ...
    Util.Get("stypeBn").addEventListener("click", function (e) {
        ...
        if (stype == "Small") stype = "Big";
        else if (stype == "Big") stype = "Small";
        com.init(stype);
        com.show();
        play.depth = 4;
        play.init();
    ...
    if (JanggiEngine.Utility.IsKingdom(x, y)) {
        ...
        if (!(x == 4 && y == 7) && !(x == 4 && y == 9) && !(x == 3 && y == 8) && !(x == 5 && y == 8)) {
            ...
            if (y - x == 4) {
                ...
                if (y == 7) {
                    // 오른아래++
                    if (y + 2 <= 9 && x + 2 <= 5 && !play.map[y + 1][x + 1] && !com.mans[map[y + 1][x + 1]] && (!com.mans[map[y + 2][x + 2]] || com.mans[map[y + 2][x + 2]].my != my)) d.push([x + 2, y + 2]);
                }

                // 왼쪽위
                if (y - 1 >= 7 && x - 1 >= 3 && (!com.mans[map[y - 1][x - 1]] || com.mans[map[y - 1][x - 1]].my != my)) d.push([x - 1, y - 1]);
                if (y == 9) {
                    if (y - 2 >= 7 && x - 2 >= 3 && !play.map[y - 1][x - 1] && !com.mans[map[y - 1][x - 1]] && (!com.mans[map[y - 2][x - 2]] || com.mans[map[y - 2][x - 2]].my != my)) d.push([x - 2, y - 2]);
                }
            ...
            if (x + y == 12) {
                ...
                // 왼쪽아래:차가 맨 오른쪽 귀
                if (y == 7) {
                    if (y + 2 <= 9 && x - 2 >= 3 && !play.map[y + 1][x - 1] && !com.mans[map[y + 1][x - 1]] && (!com.mans[map[y + 2][x - 2]] || com.mans[map[y + 2][x - 2]].my != my)) d.push([x - 2, y + 2]);
                }

                // 오른위
                if (y - 1 >= 7 && x + 1 <= 5 && (!com.mans[map[y - 1][x + 1]] || com.mans[map[y - 1][x + 1]].my != my)) d.push([x + 1, y - 1]);
                if (y == 9) {
                    if (y - 2 >= 7 && x + 2 <= 5 && !play.map[y - 1][x + 1] && !com.mans[map[y - 1][x + 1]] && (!com.mans[map[y - 2][x + 2]] || com.mans[map[y - 2][x + 2]].my != my)) d.push([x + 2, y - 2]);
                }
        ...
        if (!(x == 4 && y == 0) && !(x == 4 && y == 2) && !(x == 3 && y == 1) && !(x == 5 && y == 1)) {
            ...
            if (x <= 5 && x - y == 3) {
                ...
                if (y == 0) {
                    if (y + 2 <= 2 && x + 2 <= 5 && !play.map[y + 1][x + 1] && !com.mans[map[y + 1][x + 1]] && (!com.mans[map[y + 2][x + 2]] || com.mans[map[y + 2][x + 2]].my != my)) d.push([x + 2, y + 2]);
                }
                // 10시 방향
                if (y - 1 >= 0 && x - 1 >= 3 && (!com.mans[map[y - 1][x - 1]] || com.mans[map[y - 1][x - 1]].my != my)) d.push([x - 1, y - 1]);
                if (y == 2) {
                    if (y - 2 >= 0 && x - 2 >= 3 && !play.map[y - 1][x - 1] && !com.mans[map[y - 1][x - 1]] && (!com.mans[map[y - 2][x - 2]] || com.mans[map[y - 2][x - 2]].my != my)) d.push([x - 2, y - 2]);
                }
            }
            // 왼쪽 대각선 이동: 7시 방향
            if (x >= 3 && x + y == 5) {
                ...
                if (y == 0) {
                    if (y + 2 <= 2 && x - 2 >= 3 && !play.map[y + 1][x - 1] && !com.mans[map[y + 1][x - 1]] && (!com.mans[map[y + 2][x - 2]] || com.mans[map[y + 2][x - 2]].my != my)) d.push([x - 2, y + 2]);
                }
                // 1시 방향
                if (y - 1 >= 0 && x + 1 <= 5 && (!com.mans[map[y - 1][x + 1]] || com.mans[map[y - 1][x + 1]].my != my)) d.push([x + 1, y - 1]);
                if (y == 2) {
                    if (y - 2 >= 0 && x + 2 <= 5 && !play.map[y - 1][x + 1] && !com.mans[map[y - 1][x + 1]] && (!com.mans[map[y - 2][x + 2]] || com.mans[map[y - 2][x + 2]].my != my)) d.push([x + 2, y - 2]);
                }
            }
        }
    }
...
com.bylaw.m = function (x, y, map, my) {
    var d = [];
    //1시
    if (y - 2 >= 0 && x + 1 <= 8 && !play.map[y - 1][x] && !com.mans[map[y - 1][x]] && (!com.mans[map[y - 2][x + 1]] || com.mans[map[y - 2][x + 1]].my != my)) d.push([x + 1, y - 2]);
    //2시
    if (y - 1 >= 0 && x + 2 <= 8 && !play.map[y][x + 1] && !com.mans[map[y][x + 1]] && (!com.mans[map[y - 1][x + 2]] || com.mans[map[y - 1][x + 2]].my != my)) d.push([x + 2, y - 1]);
    //4시
    if (y + 1 <= 9 && x + 2 <= 8 && !play.map[y][x + 1] && !com.mans[map[y][x + 1]] && (!com.mans[map[y + 1][x + 2]] || com.mans[map[y + 1][x + 2]].my != my)) d.push([x + 2, y + 1]);
    //5시
    if (y + 2 <= 9 && x + 1 <= 8 && !play.map[y + 1][x] && !com.mans[map[y + 1][x]] && (!com.mans[map[y + 2][x + 1]] || com.mans[map[y + 2][x + 1]].my != my)) d.push([x + 1, y + 2]);
    //7시
    if (y + 2 <= 9 && x - 1 >= 0 && !play.map[y + 1][x] && !com.mans[map[y + 1][x]] && (!com.mans[map[y + 2][x - 1]] || com.mans[map[y + 2][x - 1]].my != my)) d.push([x - 1, y + 2]);
    //8시
    if (y + 1 <= 9 && x - 2 >= 0 && !play.map[y][x - 1] && !com.mans[map[y][x - 1]] && (!com.mans[map[y + 1][x - 2]] || com.mans[map[y + 1][x - 2]].my != my)) d.push([x - 2, y + 1]);
    //10시(왼쪽 다음 위로)
    if (y - 1 >= 0 && x - 2 >= 0 && !play.map[y][x - 1] && !com.mans[map[y][x - 1]] && (!com.mans[map[y - 1][x - 2]] || com.mans[map[y - 1][x - 2]].my != my)) d.push([x - 2, y - 1]);
    //11시(위로 다음 왼쪽)
    if (y - 2 >= 0 && x - 1 >= 0 && !play.map[y - 1][x] && !com.mans[map[y - 1][x]] && (!com.mans[map[y - 2][x - 1]] || com.mans[map[y - 2][x - 1]].my != my)) d.push([x - 1, y - 2]);
...
com.bylaw.x = function (x, y, map, my) {
    ...
    //1시
    if (y - 3 >= 0 && x + 2 <= 8 && !play.map[y - 1][x] && !com.mans[map[y - 1][x]] && (!play.map[y - 2][x + 1] && !com.mans[map[y - 2][x + 1]]) && (!com.mans[map[y - 3][x + 2]] || com.mans[map[y - 3][x + 2]].my != my)) d.push([x + 2, y - 3]);
    //2시
    if (y - 2 >= 0 && x + 3 <= 8 && !play.map[y][x + 1] && !com.mans[map[y][x + 1]] && (!play.map[y - 1][x + 2] && !com.mans[map[y - 1][x + 2]]) && (!com.mans[map[y - 2][x + 3]] || com.mans[map[y - 2][x + 3]].my != my)) d.push([x + 3, y - 2]);
    //4시
    if (y + 2 <= 9 && x + 3 <= 8 && !play.map[y][x + 1] && !com.mans[map[y][x + 1]] && (!play.map[y + 1][x + 2] && !com.mans[map[y + 1][x + 2]]) && (!com.mans[map[y + 2][x + 3]] || com.mans[map[y + 2][x + 3]].my != my)) d.push([x + 3, y + 2]);
    //5시
    if (y + 3 <= 9 && x + 2 <= 8 && !play.map[y + 1][x] && !com.mans[map[y + 1][x]] && (!play.map[y + 2][x + 1] && !com.mans[map[y + 2][x + 1]]) && (!com.mans[map[y + 3][x + 2]] || com.mans[map[y + 3][x + 2]].my != my)) d.push([x + 2, y + 3]);
    //7시
    if (y + 3 <= 9 && x - 2 >= 0 && !play.map[y + 1][x] && !com.mans[map[y + 1][x]] && (!play.map[y + 2][x - 1] && !com.mans[map[y + 2][x - 1]]) && (!com.mans[map[y + 3][x - 2]] || com.mans[map[y + 3][x - 2]].my != my)) d.push([x - 2, y + 3]);
    //8시
    if (y + 2 <= 9 && x - 3 >= 0 && !play.map[y][x - 1] && !com.mans[map[y][x - 1]] && (!play.map[y + 1][x - 2] && !com.mans[map[y + 1][x - 2]]) && (!com.mans[map[y + 2][x - 3]] || com.mans[map[y + 2][x - 3]].my != my)) d.push([x - 3, y + 2]);
    //10시
    if (y - 2 >= 0 && x - 3 >= 0 && !play.map[y][x - 1] && !com.mans[map[y][x - 1]] && (!play.map[y - 1][x - 2] && !com.mans[map[y - 1][x - 2]]) && (!com.mans[map[y - 2][x - 3]] || com.mans[map[y - 2][x - 3]].my != my)) d.push([x - 3, y - 2]);
    //11시
    if (y - 3 >= 0 && x - 2 >= 0 && !play.map[y - 1][x] && !com.mans[map[y - 1][x]] && (!play.map[y - 2][x - 1] && !com.mans[map[y - 2][x - 1]]) && (!com.mans[map[y - 3][x - 2]] || com.mans[map[y - 3][x - 2]].my != my)) d.push([x - 2, y - 3]);
...
com.bylaw.p = function (x, y, map, my) {
    ...
    if (!(x == 4 && y == 7) && !(x == 4 && y == 9) && !(x == 3 && y == 8) && !(x == 5 && y == 8)) {
        ...
        if (y - x == 4) {
            ...
            if (y == 7) {
                // 오른아래++
                if (y + 2 <= 9 && x + 2 <= 5 && (com.mans[map[y + 1][x + 1]] && com.mans[map[y + 1][x + 1]].pater != "p") && (!com.mans[map[y + 2][x + 2]] || com.mans[map[y + 2][x + 2]].my != my)) d.push([x + 2, y + 2]);
            }

            // 왼쪽위
            if (y == 9) {
                if (y - 2 >= 7 && x - 2 >= 3 && (com.mans[map[y - 1][x - 1]] && com.mans[map[y - 1][x - 1]].pater != "p") && (!com.mans[map[y - 2][x - 2]] || com.mans[map[y - 2][x - 2]].my != my)) d.push([x - 2, y - 2]);
            }
        ...
        if (x + y == 12) {
            ...
            // 왼쪽아래:포가 맨 오른쪽 귀
            if (y == 7) {
                if (y + 2 <= 9 && x - 2 >= 3 && (com.mans[map[y + 1][x - 1]] && com.mans[map[y + 1][x - 1]].pater != "p") && (!com.mans[map[y + 2][x - 2]] || com.mans[map[y + 2][x - 2]].my != my)) d.push([x - 2, y + 2]);
            }

            // 오른위
            if (y == 9) {
                if (y - 2 >= 7 && x + 2 <= 5 && (com.mans[map[y - 1][x + 1]] && com.mans[map[y - 1][x + 1]].pater != "p") && (!com.mans[map[y - 2][x + 2]] || com.mans[map[y - 2][x + 2]].my != my)) d.push([x + 2, y - 2]);
            }
    ...
    if (!(x == 4 && y == 0) && !(x == 4 && y == 2) && !(x == 3 && y == 1) && !(x == 5 && y == 1)) {
        ...
        if (x <= 5 && x - y == 3) {
            // 4시 방향
            if (y == 0) {
                if (y + 2 <= 2 && x + 2 <= 5 && (com.mans[map[y + 1][x + 1]] && com.mans[map[y + 1][x + 1]].pater != "p") && (!com.mans[map[y + 2][x + 2]] || com.mans[map[y + 2][x + 2]].my != my)) d.push([x + 2, y + 2]);
            }
            // 10시 방향
            if (y == 2) {
                if (y - 2 >= 0 && x - 2 >= 3 && (com.mans[map[y - 1][x - 1]] && com.mans[map[y - 1][x - 1]].pater != "p") && (!com.mans[map[y - 2][x - 2]] || com.mans[map[y - 2][x - 2]].my != my)) d.push([x - 2, y - 2]);
            }
        }
        // 왼쪽 대각선 이동: 7시 방향
        if (x >= 3 && x + y == 5) {
            // 7시 방향
            if (y == 0) {
                if (y + 2 <= 2 && x - 2 >= 3 && (com.mans[map[y + 1][x - 1]] && com.mans[map[y + 1][x - 1]].pater != "p") && (!com.mans[map[y + 2][x - 2]] || com.mans[map[y + 2][x - 2]].my != my)) d.push([x - 2, y + 2]);
            }
            // 1시 방향
            if (y == 2) {
                if (y - 2 >= 0 && x + 2 <= 5 && (com.mans[map[y - 1][x + 1]] && com.mans[map[y - 1][x + 1]].pater != "p") && (!com.mans[map[y - 2][x + 2]] || com.mans[map[y - 2][x + 2]].my != my)) d.push([x + 2, y - 2]);
            }
        }
    }
...
com.value = {
    ...
    z: [
        ...
        [42, 46, 43, 176, 1000, 176, 43, 46, 42],
        [42, 46, 43, 386, 400, 386, 43, 46, 42],
        [35, 46, 43, 290, 300, 290, 43, 46, 35],
...
com.args = {
    // 초(Blue)
    'c': { text: "차", img: 'b_c', my: 1, bl: "c", value: com.value.c, score: 13     },
    'm': { text: "마", img: 'b_m', my: 1, bl: "m", value: com.value.m, score: 5      },
    'x': { text: "상", img: 'b_x', my: 1, bl: "x", value: com.value.x, score: 3      },
    's': { text: "사", img: 'b_s', my: 1, bl: "s", value: com.value.s, score: 3      },
    'j': { text: "초", img: 'b_j', my: 1, bl: "j", value: com.value.j, score: 8888   },
    'p': { text: "포", img: 'b_p', my: 1, bl: "p", value: com.value.p, score: 7      },
    'z': { text: "졸", img: 'b_z', my: 1, bl: "z", value: com.value.z, score: 2      },

    // 한(Red)
    'C': { text: "차", img: 'r_c', my: -1, bl: "c", value: com.value.C, score: 13 },
    'M': { text: "마", img: 'r_m', my: -1, bl: "m", value: com.value.M, score: 5 },
    'X': { text: "상", img: 'r_x', my: -1, bl: "x", value: com.value.X, score: 3 },
    'S': { text: "사", img: 'r_s', my: -1, bl: "s", value: com.value.S, score: 3 },
    'J': { text: "한", img: 'r_j', my: -1, bl: "j", value: com.value.J, score: 8888 },
    'P': { text: "포", img: 'r_p', my: -1, bl: "p", value: com.value.P, score: 7 },
    'Z': { text: "병", img: 'r_z', my: -1, bl: "z", value: com.value.Z, score: 2 }
};
...
com.class.Bg = function (img, x, y) {
    ...
    this.show = function () {
        if (this.isShow) com.ctx.drawImage(com.bgImg, com.spaceX * this.x, com.spaceY * this.y);
    }
}
...
com.class.Dot = function (img, x, y) {
    ...
    this.show = function () {
        for (var i = 0; i < this.dots.length; i++) {
            if (this.isShow) com.ctx.drawImage(com.dotImg, com.spaceX * this.dots[i][0] + 10 + com.pointStartX, com.spaceY * this.dots[i][1] + 10 + com.pointStartY)
        }
    }
}
